    ...
    <div 
     ...
     className="w-full h-screen bg-[#ff775e] shadow-inner z-20">
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
            ...
            <p className="text-xl mt-10 selection:bg-[#f4a33d] text-white">Hi, I'm Terry Davis Raffael, but all my friends used to call me raffael or rafa, I'm a student from SMK Wira Harapan. I have 3 year's of experience at programing, I've been programing since 2020. The only langueges that I've been learning was Html, CSS, JavaScript, php, and C++. </p>
            
            <br />

            <p className="text-xl selection:bg-[#f4a33d] text-white">My hobbies are Programing and Photography. I am still learning new langueges such as Next.Js, React, TypeScript, and tailwind. Yes, I did mention Photography, why did i mention this? it's because i love taking pictures most of my website is using my own shot of picture's. If you are interested on my picture's 
